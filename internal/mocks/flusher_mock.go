...
// Source: github.com/ozoncp/ocp-certificate-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []model.Certificate) []model.Certificate {
	m.ctrl.T.Helper()
