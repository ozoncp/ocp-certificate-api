...
func request_OcpCertificateApi_RemoveCertificateV1_0(ctx context.Context, marshaler runtime.Marshaler, client OcpCertificateApiClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RemoveCertificateV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := client.RemoveCertificateV1(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_OcpCertificateApi_RemoveCertificateV1_0(ctx context.Context, marshaler runtime.Marshaler, server OcpCertificateApiServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq RemoveCertificateV1Request
	var metadata runtime.ServerMetadata
	...
	msg, err := server.RemoveCertificateV1(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterOcpCertificateApiHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OcpCertificateApiServer) error {
	...
	mux.Handle("DELETE", pattern_OcpCertificateApi_RemoveCertificateV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		resp, md, err := local_request_OcpCertificateApi_RemoveCertificateV1_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_OcpCertificateApi_RemoveCertificateV1_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOcpCertificateApiHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OcpCertificateApiClient) error {
	...
	mux.Handle("DELETE", pattern_OcpCertificateApi_RemoveCertificateV1_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OcpCertificateApi_RemoveCertificateV1_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_OcpCertificateApi_RemoveCertificateV1_0 = runtime.ForwardResponseMessage
)
